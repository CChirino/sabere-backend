...
<head>
    ...
    <title>Nueva calificación asignada</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>📚 Nueva calificación asignada</h1>
        </div>
        <div class="content">
            <p>Hola <strong>{{ $user->name }}</strong>,</p>
            <p>Se ha asignado una nueva calificación:</p>
            ...
            <center>
                <a href="{{ url('/student/scores') }}" class="btn">Ver mis calificaciones</a>
            </center>
        </div>
        <div class="footer">
