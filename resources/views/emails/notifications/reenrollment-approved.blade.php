...
<head>
    ...
    <title>Reinscripción Aprobada</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            <h1>✅ Reinscripción Aprobada</h1>
        </div>
        <div class="content">
            <p>Hola <strong>{{ $user->name }}</strong>,</p>

            <div class="success-badge">
                ¡Tu solicitud de reinscripción ha sido aprobada!
            </div>

            <p>Nos complace informarte que has sido reinscrito exitosamente para el siguiente período académico:</p>
            ...
            <center>
                <a href="{{ url('/student/dashboard') }}" class="btn">Ir al panel</a>
            </center>
        </div>
        <div class="footer">
