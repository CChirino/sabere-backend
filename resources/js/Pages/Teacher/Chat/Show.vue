...
const sendMessage = () => {
    ...
    const optimisticMessage: Message = {
        ...
        user: {
            ...
            name: props.teachers.find(t => t.id === props.currentUserId)?.name || 
                  props.students.find(s => s.id === props.currentUserId)?.name || 'Tú',
        },
        is_mine: true,
    ...
    form.post(route('teacher.chat.store', props.section.id), {
        preserveScroll: true,
        onSuccess: () => {
            form.reset('message');
        },
...
const isTeacher = (userId: number) => {
    return props.teachers.some(t => t.id === userId);
};
        ...
        <div class="flex flex-col h-[calc(100vh-4rem)]">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">
                            {{ section.academic_period }} · {{ students.length }} estudiantes · {{ teachers.length }} profesores
                        </p>
                    </div>
                </div>
            ...
            >
                ...
                <div v-if="messages.length === 0" class="flex flex-col items-center justify-center h-full text-gray-500">
                    ...
                    <p class="text-lg font-medium">¡Bienvenido al chat de {{ section.full_name }}!</p>
